...
class DigitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create digital" do
    assert_difference('Digital.count') do
      post digitals_url, params: { digital: { name: @digital.name, price: @digital.price, sku: @digital.sku, stock: @digital.stock } }
    end
  ...
  test "should update digital" do
    patch digital_url(@digital), params: { digital: { name: @digital.name, price: @digital.price, sku: @digital.sku, stock: @digital.stock } }
